...
const Testimonial = () => {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      ...
      <div class="grid mb-8 lg:mb-12 lg:grid-cols-2">
          <figure class="flex flex-col justify-center items-center p-8 text-center bg-pink-50 border-b border-gray-200 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-900 dark:text-gray-900">
                  <h3 class="text-lg font-semibold text-black-900 dark:text-white">Speechless with how easy this was to integrate</h3>
              ...
              <figcaption class="flex justify-center items-center space-x-3">
                  ...
                  <div class="space-y-0.5 font-medium text-gray-950 text-xl dark:text-white text-left">
                      <div className="font-medium">Bonnie Green</div>
                      <div class="text-sm font-light text-gray-900 dark:text-gray-400">Developer at Open AI</div>
                  </div>
              </figcaption>    
          </figure>
          <figure class="flex flex-col justify-center items-center p-8 text-center bg-pink-50 border-b border-gray-200 md:p-12 dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-900 dark:text-gray-900">
              ...
              <figcaption class="flex justify-center items-center space-x-3">
                  ...
                  <div class="space-y-0.5 font-medium text-xl text-gray-950 dark:text-white text-left">
                      <div >Roberta Casas</div>
                      <div class="text-sm font-light text-gray-900 dark:text-gray-900">Lead designer at Dropbox</div>
                  </div>
              </figcaption>    
          </figure>
          <figure class="flex flex-col justify-center items-center p-8 text-center bg-pink-50 border-b border-gray-200 lg:border-b-0 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-900 dark:text-gray-400">
              ...
              <figcaption class="flex justify-center items-center space-x-3">
                  ...
                  <div class="space-y-0.5 font-medium text-xl text-gray-950 dark:text-white text-left">
                      <div>Jese Leos</div>
                      <div class="text-sm font-light text-gray-900 dark:text-gray-900">Software Engineer at Facebook</div>
                  </div>
              </figcaption>    
          </figure>
          <figure class="flex flex-col justify-center items-center p-8 text-center bg-pink-50 border-gray-200 md:p-12 dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-900 dark:text-gray-900">
              ...
              <figcaption class="flex justify-center items-center space-x-3">
                  ...
                  <div class="space-y-0.5 font-medium text-xl text-gray-950 dark:text-white text-left">
                      ...
                      <div class="text-sm font-light text-gray-900 dark:text-gray-900">CTO at Google</div>
                  </div>
              </figcaption>    
          </figure>
      </div>
      <div class="text-center">
          <button href="#" class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-white-900 focus:outline-none bg-blue-900 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Show more...</button> 
      </div>
      </div>
</section>
        </div>
