        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <div class="flex items-center">
                  <img src="https://i.ibb.co/ZS5PBND/logo.png" class="h-8 mr-3" alt="FlowBite Logo" />
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Food & Beverage</span>
              </div>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <p class="hover:underline text-white">Flowbite</p>
                      </li>
                      <li>
                          <p  class="hover:underline text-white">Tailwind CSS</p>
                      </li>
                  </ul>
              </div>
              <div>
